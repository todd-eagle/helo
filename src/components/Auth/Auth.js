...
class Auth extends Component {
    ...
    render(){
        ...
        return(
            ...
            <h1 className="App-login-heading">Helo</h1>
            <form className="App-login-form">
                ...
                <div className="App-login-buttons">
                    <button className="App-Auth-button" type="submit" onClick={e => this.login(e)}>Login</button>
                    <button className="App-Auth-button" type="submit" onClick={e => this.register(e)}>Register</button>
                </div>
            </form>
            </div>
            </div>
